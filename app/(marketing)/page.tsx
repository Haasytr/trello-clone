    ...
    return (
        <div className="flex items-center justify-center flex-col">
            <div className={
                ...
                <div 
                    className="mb-4 flex items-center border 
            ...
            <div className={
                ...
                Collabore, manage projects, and reach new productivy peaks. From high rises to the home office, the way your
                team works in unique. - accomplish it all with Taskify
            </div>
